...
# Con actualización automática de templates nuclei si faltan
python3 SuperReconn.py example.com --update-nuclei-templates
...
│   ├── health_report.txt           # Estado por fase (ok/failed/skipped)
